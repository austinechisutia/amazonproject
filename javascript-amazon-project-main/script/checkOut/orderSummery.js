...
// default exports are used to export variables and functions
// from this file to other files
...
cart.forEach((cartItem)=>{
 ...
 const deliveryOtonId = cartItem.deliveryOptionsId;

 const deliveryOption = getDeliveryOption(deliveryOtonId);
...
// to compile the html, we need to use a template literal again we creat a variable on top
 cartSummaryHtml += `
